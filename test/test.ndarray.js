...
tape( 'the function has an arity of 5', function test( t ) {
	t.strictEqual( gsome.length, 5, 'has expected arity' );
	t.end();
});
...
tape( 'the function tests whether a strided array contains at least k truthy elements', function test( t ) {
	...
	x = [ 0, 0, 1, 2 ];
	v = gsome( x.length, 2, x, 1, 0 );
	t.strictEqual( v, true, 'returns expected value' );

	x = [ 0, 0, 0, 0 ];
	v = gsome( x.length, 1, x, 1, 0 );
	t.strictEqual( v, false, 'returns expected value' );

	x = [ 1, 2, 3, 4 ];
	v = gsome( x.length, 5, x, 1, 0 );
	t.strictEqual( v, false, 'returns expected value' );

	x = [ 1, 2, 3, 4 ];
	v = gsome( x.length, 4, x, 1, 0 );
	t.strictEqual( v, true, 'returns expected value' );
...
tape( 'the function tests whether a strided array contains at least k truthy elements (accessors)', function test( t ) {
	...
	x = [ 0, 0, 1, 2 ];
	v = gsome( x.length, 2, toAccessorArray( x ), 1, 0 );
	t.strictEqual( v, true, 'returns expected value' );

	x = [ 0, 0, 0, 0 ];
	v = gsome( x.length, 1, toAccessorArray( x ), 1, 0 );
	t.strictEqual( v, false, 'returns expected value' );

	x = [ 1, 2, 3, 4 ];
	v = gsome( x.length, 5, toAccessorArray( x ), 1, 0 );
	t.strictEqual( v, false, 'returns expected value' );

	x = [ 1, 2, 3, 4 ];
	v = gsome( x.length, 4, toAccessorArray( x ), 1, 0 );
	t.strictEqual( v, true, 'returns expected value' );
...
tape( 'if provided an `N` parameter less than or equal to `0`, the function returns `false` (accessors)', function test( t ) {
	...
	v = gsome( 0, 1, toAccessorArray( x ), 1, 0 );
	t.strictEqual( v, false, 'returns expected value' );

	v = gsome( -1, 1, toAccessorArray( x ), 1, 0 );
	t.strictEqual( v, false, 'returns expected value' );
...
tape( 'the function supports a `stride` parameter (accessors)', function test( t ) {
	...
	v = gsome( 3, 2, toAccessorArray( x ), 2, 0 );
	t.strictEqual( v, true, 'returns expected value' );

	v = gsome( 3, 1, toAccessorArray( x ), 2, 0 );
	t.strictEqual( v, true, 'returns expected value' );
...
tape( 'the function supports an `offset` parameter (accessors)', function test( t ) {
	...
	v = gsome( 2, 2, toAccessorArray( x ), 1, 1 );
	t.strictEqual( v, true, 'returns expected value' );

	v = gsome( 2, 3, toAccessorArray( x ), 1, 1 );
	t.strictEqual( v, false, 'returns expected value' );
...
tape( 'the function supports a stride of `0` (accessors)', function test( t ) {
	...
	x = [ 0, 0, 0, 0 ];
	v = gsome( 2, 1, toAccessorArray( x ), 0, 0 );
	t.strictEqual( v, false, 'returns expected value' );
	...
	x = [ 1, 1, 1, 1 ];
	v = gsome( 3, 2, toAccessorArray( x ), 0, 0 );
	t.strictEqual( v, true, 'returns expected value' );
	...
	x = [ 1, 1, 1, 1 ];
	v = gsome( 2, 3, toAccessorArray( x ), 0, 0 );
	t.strictEqual( v, false, 'returns expected value' );
...
tape( 'the function supports negative strides (accessors)', function test( t ) {
	...
	v = gsome( 3, 2, toAccessorArray( x ), -2, 5 );
	t.strictEqual( v, true, 'returns expected value' );
